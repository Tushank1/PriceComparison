  ...
  return (
    <div className="guide_H_I">
      ...
      <div className="guide_cart">
        ...
        <div className="guide_H_I_content" onClick={() => navigate("/eleven")}>
          <img
        ...
        <div className="guide_H_I_content" onClick={() => navigate("/twelve")}>
          <img
        ...
        <div className="guide_H_I_content" onClick={() => navigate("/first")}>
          ...
          />
          <h3>
            8 tips for home studying: How to be disciplined when you're studying
            from home
          </h3>
          <span>
            By <span>Elina Blom</span>
          ...
          <p>
            Schools in the UK are moving over to distance learning. Here we give
